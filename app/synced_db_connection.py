...
class PostgresConnection:
    ...
    async def initialize(self):
        ...
        """
        try:
            POSTGRES_URL = settings.SYNCED_DB_URL
            ...
            logger.info("Synced PostgreSQL connection established successfully")

        except Exception as e:
            logger.error(f"Failed to establish Synced PostgreSQL connection: {str(e)}")
            raise ConnectionError(f"Synced PostgreSQL connection failed: {str(e)}")
    ...
    async def get_pool(self):
        ...
        if self._pool is None:
            raise ConnectionError("Synced PostgreSQL connection not initialized. Call initialize() first.")
        return self._pool
    ...
    async def close(self):
        ...
        if self._pool is not None:
            ...
            self._pool = None
            logger.info("Synced PostgreSQL connection closed")

def get_synced_db_client():
    """
