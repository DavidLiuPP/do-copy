...
DEFAULT_VRP_ASSUMPTIONS = {
    ...
    'SKIP_NODE_PENALTY_FOR_OPTIONAL_MOVE': SKIP_NODE_PENALTY_FOR_OPTIONAL_MOVE,
    ...
    'PENALTY_FOR_COMPANY_DRIVER_LONG_DISTANCE_MOVE': PENALTY_FOR_COMPANY_DRIVER_LONG_DISTANCE_MOVE,
    'NON_DUAL_MOVE_PENALTY': NON_DUAL_MOVE_PENALTY
}
